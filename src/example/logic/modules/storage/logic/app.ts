import { APIStorageNode, AppAPIContainer, api } from '@/example/logic/api'
import { BaseLogic, getStorageNodeURL } from '@/example/logic/base'
...
import { StorageUrlUploadManager } from '@/example/logic/modules/storage/upload-url'
