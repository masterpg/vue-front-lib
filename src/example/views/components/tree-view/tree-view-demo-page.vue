...
import { CompTreeCheckboxNode, CompTreeCheckboxNodeData, CompTreeView, CompTreeViewEvent } from '@/example/components'
...
export default class TreeViewDemoPage extends mixins(BaseComponent, Resizable) {
  ...
  private m_addNode() {
    const parentNode = this.m_treeView.getNode(this.m_addedInput.parentValue)!
