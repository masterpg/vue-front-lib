...
import StorageDirView, { IStorageDirView } from '@/example/views/base/storage/storage-dir-view.vue'
...
import StorageDirDetailView from '@/example/views/base/storage/storage-dir-detail-view.vue'
