...
<script lang="ts">
import { AuthMessageView, ProviderListView } from '@/app/dialog/auth/base'
import EmailSignUpView, { EmailSignUpViewResult } from '@/app/dialog/auth/sign-up-dialog/email-sign-up-view.vue'
