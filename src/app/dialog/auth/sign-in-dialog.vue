...
<script lang="ts">
import { AuthMessageView, EmailSignInView, EmailSignInViewResult } from '@/app/dialog/auth/base'
import { AuthStatus } from '@/app/logic'
import { BaseDialog } from '@/app/base'
import { Component } from 'vue-property-decorator'
import PasswordResetView from '@/app/dialog/auth/base/password-reset-view.vue'
import ProviderListView from '@/app/dialog/auth//base/provider-list-view.vue'
import { QDialog } from 'quasar'
import { UserEntry } from '@/app/dialog/history-dialog-manager.vue'
import { dialogManager } from '@/app/dialog'
