...
<script lang="ts">
import { AuthStatus, UserInfo } from '@/app/logic'
import { BaseComponent, NoCache, Resizable } from '@/app/base'
import { Component, Watch } from 'vue-property-decorator'
import { EmailChange, HistoryDialogManager, SignIn, SignUp, UserDelete, UserEntry, dialogManager, initDialog } from '@/app/dialog'
import { SWChangeState, SWStateChangeInfo, sw } from '@/app/sw'
