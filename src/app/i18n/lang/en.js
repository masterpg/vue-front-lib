export default {
  ...
  article: {
    ...
    reflectMasterQ: 'Are you sure you want to reflect the draft to the master?',
    ...
    discardDraftQ: 'Are you sure you want to discard the draft file?',
    discardDraftError: 'An error occurred while discarding the draft.',
    nodeType: {
