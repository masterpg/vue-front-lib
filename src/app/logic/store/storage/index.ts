...
interface StorageStoreImpl extends StorageStore {
  state: StorageState
}
...
function createStorageStore(): StorageStoreImpl {
  //----------------------------------------------------------------------
  //
  //  Variables
  //
  ...
  // function clone(node: DeepReadonly<StorageNode>): StorageNode {
  //   return StorageNode.clone(node)
  // }
...
export { StorageNodeForSet, StorageStore, StorageStoreImpl, createStorageStore }
