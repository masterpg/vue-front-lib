...
<template>
  <div class="MarkdownItDemoPage">
    <div class="full-height layout horizontal">
      <!-- Markdown入力エリア -->
      <div ref="editorContainer" class="flex-1 editor-container" @mouseover="editorContainerOnStartScroll" @touchstart="editorContainerOnStartScroll">
...
export default MarkdownDemoPage.clazz
</script>
