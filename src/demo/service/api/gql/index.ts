import { CartItemAddInput, CartItemEditResponse, CartItemUpdateInput, RawCartItem, RawProduct, ShopAPIContainer } from '@/demo/service/api/base'
import { RawEntity, toEntities, toEntity } from '@/app/service/api/base'
import { GQLAPIClient } from '@/app/service/api/gql/client'
import { GQLAPIContainer } from '@/app/service/api/gql'
