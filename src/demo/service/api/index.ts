import { APIContainer, injectAPI as _injectAPI, provideAPI as _provideAPI } from '@/app/service/api'
import { WritableComputedRef, computed, reactive } from '@vue/composition-api'
import { DemoGQLAPIContainer } from '@/demo/service/api/gql'
import { DemoRESTAPIContainer } from '@/demo/service/api/rest'
import { ShopAPIContainer } from '@/demo/service/api/base'
