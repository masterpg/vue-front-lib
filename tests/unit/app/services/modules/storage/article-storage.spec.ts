...
describe('AppStorageService', () => {
  ...
  beforeEach(async () => {
    provideDependency(({ services }) => {
      ...
      services.articleStorage.basePath.value = basePath
      // ベースパスノードの作成
      ...
      // ショートハンド用変数にメソッドを設定
      toBasePath = services.articleStorage.toBasePath
      toBasePaths = services.articleStorage.toBasePaths
      toBasePathNode = services.articleStorage.toBasePathNode
      toFullPath = services.articleStorage.toFullPath
    })
  })
  ...
  describe('fetchRoot', () => {
    it('ベーシックケース - 構成ノードが未読み込み(構成ノードは存在する)', async () => {
      const {
        services: { articleStorage, appStorage },
      } = provideDependency()
  ...
  describe('renameDir', () => {
    it('ベーシックケース - 記事系ノード', async () => {
      ...
      const {
        ...
        stores.storage.setAll([users, userRoot, articles, bundle])
      })
    ...
    it('ベーシックケース - 一般ノード', async () => {
      ...
      const {
        ...
        stores.storage.setAll([users, userRoot, articles, assets, d1])
      })
  ...
  describe('renameFile', () => {
    it('ベーシックケース - 一般ノード', async () => {
      ...
      const {
        ...
        stores.storage.setAll([users, userRoot, articles, assets, f1])
      })
  ...
  describe('createDir', () => {
    it('ベーシックケース', async () => {
      ...
      const {
        ...
        stores.storage.setAll([users, userRoot, articles, bundle, cat1, art1])
      })
    ...
    it('階層を構成するノードが欠けていた場合', async () => {
      ...
      const {
        ...
        // ※｢bundle｣が欠けているように設定
        stores.storage.setAll([users, userRoot, articles, cat1, art1])
      })
  ...
  describe('createArticleTypeDir', () => {
    it('ベーシックケース - バンドル作成', async () => {
      ...
      const {
        ...
        stores.storage.setAll([users, userRoot, articles])
      })
    ...
    it('ベーシックケース - 記事ディレクトリ作成', async () => {
      ...
      const {
        ...
        stores.storage.setAll([users, userRoot, articles, bundle, cat1])
      })
    ...
    it('階層を構成するノードが欠けていた場合', async () => {
      ...
      const {
        ...
        // ※｢bundle｣が欠けているように設定
        stores.storage.setAll([users, userRoot, articles, cat1])
      })
  ...
  describe('setArticleSortOrder', () => {
    it('ベーシックケース', async () => {
      ...
      const {
        ...
        stores.storage.setAll([users, userRoot, articles, bundle, art2, art1])
      })
    ...
    it('大量データの場合', async () => {
      ...
      const {
        ...
        stores.storage.setAll([users, userRoot, articles, bundle, ...arts])
      })
  ...
  describe('saveArticleSrcMasterFile', () => {
    it('ベーシックケース', async () => {
      ...
      const {
        ...
        stores.storage.setAll([users, userRoot, articles, bundle, art1, art1_master, art1_draft])
      })
