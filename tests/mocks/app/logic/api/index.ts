...
import { AppGQLAPIContainer, RawUser } from '@/app/logic/api/gql'
...
interface TestAPIContainer extends AppAPIContainer {
...
function TestGQLAPIContainerMixin(superclass: Constructor<AppGQLAPIContainer>): Constructor<TestAPIContainer> {
...
function initTestAPI(api?: AppAPIContainer): void {
